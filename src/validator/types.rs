...
pub trait TypeIdentifier: crate::std::fmt::Debug + Copy + Eq + Sized + 'static {
...
/// [`TypeIdentifier`].
pub trait TypeData: crate::std::fmt::Debug {
...
macro_rules! define_type_id {
    ($name:ident, $data:ty, $list:ident, $type_str:expr) => {
        ...
        const _: () = {
            assert!(crate::std::mem::size_of::<$name>() <= 4);
        };
    };
}
...
const _: () = {
    assert!(crate::std::mem::size_of::<CoreTypeId>() <= 4);
};
...
const _: () = {
    assert!(crate::std::mem::size_of::<ComponentDefinedTypeId>() <= 8);
};
...
pub struct ModuleType {
    ...
    pub imports: IndexMap<(String, String), EntityType, RandomState>,
    /// The exports of the module type.
    pub exports: IndexMap<String, EntityType, RandomState>,
}
...
pub enum CoreInstanceTypeKind {
    ...
    Exports(IndexMap<String, EntityType, RandomState>),
}
...
impl InstanceType {
    ...
    pub fn exports<'a>(
        &'a self,
        types: TypesRef<'a>,
    ) -> &'a IndexMap<String, EntityType, RandomState> {
...
pub struct ComponentType {
    ...
    pub explicit_resources: IndexMap<ResourceId, Vec<usize>, RandomState>,
}
...
pub struct RecordType {
    ...
    pub fields: IndexMap<KebabString, ComponentValType, RandomState>,
}
...
pub struct VariantType {
    ...
    pub cases: IndexMap<KebabString, VariantCase, RandomState>,
}
...
impl TypeAlloc {
    ...
    pub fn free_variables_any_type_id(
        ...
        set: &mut IndexSet<ResourceId, RandomState>,
    ) {
        match id {
    ...
    pub(crate) fn type_named_type_id(
        ...
        match ty {
            ...
            | ComponentDefinedType::Variant(_) => set.contains::<ComponentAnyTypeId>(&id.into()),
    ...
    Self: Index<ComponentFuncTypeId, Output = ComponentFuncType>,
{
    ...
    /// keys were remapped.
    fn map_map(
        tmp: &mut IndexMap<ResourceId, Vec<usize>, RandomState>,
