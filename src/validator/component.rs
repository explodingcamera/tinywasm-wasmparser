...
pub(crate) struct ComponentState {
    ...
    pub import_names: IndexSet<ComponentName, RandomState>,
    pub exports: IndexMap<String, ComponentEntityType, RandomState>,
    pub export_names: IndexSet<ComponentName, RandomState>,
    ...
    explicit_resources: IndexMap<ResourceId, Vec<usize>, RandomState>,
...
struct ComponentNameContext {
    ...
    /// in this set.
    all_resource_names: IndexSet<String, RandomState>,
}
...
impl ComponentState {
    ...
    fn all_valtypes_named_in_defined(
        ...
        match ty {
            ...
            ComponentDefinedType::Own(id) | ComponentDefinedType::Borrow(id) => {
                set.contains::<ComponentAnyTypeId>(&(*id).into())
            }
        }
    }
    ...
    fn create_function_type(
        ...
        let mut set = HashSet::with_capacity(crate::std::cmp::max(
            ty.params.len(),
            ty.results.type_count(),
        ));
    ...
    fn instantiate_core_module(
        ...
        fn insert_arg<'a>(
            name: &'a str,
            arg: &'a InstanceType,
            args: &mut IndexMap<&'a str, &'a InstanceType, RandomState>,
            offset: usize,
        ) -> Result<()> {
        ...
        let mut args = IndexMap::with_hasher(RandomState::default());
    ...
    fn instantiate_component(
        ...
        if cfg!(debug_assertions) {
            let mut free = IndexSet::with_hasher(RandomState::default());
    ...
    fn instantiate_component_exports(
        ...
        let mut info = TypeInfo::new();
        let mut inst_exports = IndexMap::with_hasher(RandomState::default());
        ();
        let mut explicit_resources = IndexMap::with_hasher(RandomState::default());
        ();
        let mut export_names = IndexSet::with_hasher(RandomState::default());
    ...
    fn instantiate_core_exports(
        ...
        fn insert_export(
            ...
            name: &str,
            export: EntityType,
            exports: &mut IndexMap<String, EntityType, RandomState>,
            info: &mut TypeInfo,
            offset: usize,
        ) -> Result<()> {
    ...
    fn create_record_type(
        ...
        let mut info = TypeInfo::new();
        let mut field_map =
            IndexMap::with_capacity_and_hasher(fields.len(), RandomState::default());
    ...
    fn create_variant_type(
        ...
        let mut info = TypeInfo::new();
        let mut case_map: IndexMap<KebabString, VariantCase, RandomState> =
            IndexMap::with_capacity_and_hasher(cases.len(), RandomState::default());
    ...
    fn create_flags_type(&self, names: &[&str], offset: usize) -> Result<ComponentDefinedType> {
        let mut names_set = IndexSet::with_capacity_and_hasher(names.len(), RandomState::default());
    ...
    fn create_enum_type(&self, cases: &[&str], offset: usize) -> Result<ComponentDefinedType> {
        ...
        let mut tags = IndexSet::with_capacity_and_hasher(cases.len(), RandomState::default());
...
impl ComponentNameContext {
    ...
    fn validate_extern(
        ...
        types: &TypeAlloc,
        offset: usize,
        kind_names: &mut IndexSet<ComponentName, RandomState>,
        items: &mut IndexMap<String, ComponentEntityType, RandomState>,
        info: &mut TypeInfo,
        features: &WasmFeatures,
    ) -> Result<()> {
...
mod append_only {
    ...
    pub struct IndexMapAppendOnly<K, V>(IndexMap<K, V, RandomState>);
    ...
    impl<K, V> Deref for IndexMapAppendOnly<K, V> {
        ...
        fn deref(&self) -> &IndexMap<K, V, RandomState> {
            &self.0
        }
    }
    ...
    impl<K, V> IntoIterator for IndexMapAppendOnly<K, V> {
        type IntoIter = <IndexMap<K, V, RandomState> as IntoIterator>::IntoIter;
        type Item = <IndexMap<K, V, RandomState> as IntoIterator>::Item;
