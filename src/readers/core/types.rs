...
use crate::std::fmt::{self, Debug, Write};
...
impl crate::std::fmt::Debug for PackedIndex {
...
impl crate::std::fmt::Display for PackedIndex {
    fn fmt(&self, f: &mut crate::std::fmt::Formatter<'_>) -> crate::std::fmt::Result {
        crate::std::fmt::Display::fmt(&self.unpack(), f)
    }
}
...
impl crate::std::fmt::Display for UnpackedIndex {
    fn fmt(&self, f: &mut crate::std::fmt::Formatter<'_>) -> crate::std::fmt::Result {
        match self {
...
impl RecGroup {
    ...
    pub fn types(&self) -> impl ExactSizeIterator<Item = &SubType> + '_ {
        let types = match &self.inner {
            RecGroupInner::Implicit(ty) => crate::std::slice::from_ref(ty),
    ...
    pub(crate) fn types_mut(&mut self) -> impl ExactSizeIterator<Item = &mut SubType> + '_ {
        let types = match &mut self.inner {
            RecGroupInner::Implicit(ty) => crate::std::slice::from_mut(ty),
            RecGroupInner::Explicit(types) => types,
        };
...
impl crate::std::fmt::Display for SubType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        if self.is_final && self.supertype_idx.is_none() {
            crate::std::fmt::Display::fmt(&self.composite_type, f)
        } else {
            write!(f, "(sub ")?;
            if self.is_final {
                write!(f, "final ")?;
...
impl crate::std::fmt::Display for CompositeType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
...
impl crate::std::fmt::Debug for FuncType {
    fn fmt(&self, f: &mut crate::std::fmt::Formatter<'_>) -> crate::std::fmt::Result {
...
impl crate::std::fmt::Display for StorageType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::I8 => write!(f, "i8"),
            Self::I16 => write!(f, "i16"),
            Self::Val(v) => crate::std::fmt::Display::fmt(v, f),
        }
    }
}
...
impl crate::std::fmt::Display for ValType {
    fn fmt(&self, f: &mut crate::std::fmt::Formatter<'_>) -> crate::std::fmt::Result {
        match self {
            ...
            ValType::Ref(r) => crate::std::fmt::Display::fmt(r, f),
        }
    }
}
...
impl crate::std::fmt::Debug for RefType {
    fn fmt(&self, f: &mut crate::std::fmt::Formatter<'_>) -> crate::std::fmt::Result {
...
impl crate::std::fmt::Display for RefType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
